...
public class CloneTest {
    ...
    public static void main(String[] args) {
        ...
        //1.使用org.apache.commons.beanutils.BeanUtils.copyProperties(Object dest, Object orig);
        Long start1 = System.currentTimeMillis();

        while (count < 1000) {
            cosmosN1 = new CosmosN();
            try {
                BeanUtils.copyProperties(cosmosN1, cosmosY);
        ...
        while (count < 2000) {
            cosmosN2 = new CosmosN();
            org.springframework.beans.BeanUtils.copyProperties(cosmosY, cosmosN2);
            count++;
        }
        Long end2 = System.currentTimeMillis();
        long spend2 = end2 - start2;
        //3.使用net.sf.cglib.beans.BeanCopier.copy(from, to, null);
        // 先定义 net.sf.cglib.beans.BeanCopier.create
        Long start3 = System.currentTimeMillis();
        while (count < 3000) {
            cosmosN3 = new CosmosN();
            net.sf.cglib.beans.BeanCopier beanCopier = net.sf.cglib.beans.BeanCopier.create(CosmosY.class, CosmosN.class, false);
            beanCopier.copy(cosmosY, cosmosN3, null);
            count++;
        }
        Long end3 = System.currentTimeMillis();
        long spend3 = end3 - start3;
        //4.org.springframework.cglib.beans.BeanCopier.copy(from, to, null);
        Long start4 = System.currentTimeMillis();
        while (count < 4000) {
            cosmosN4 = new CosmosN();
            org.springframework.cglib.beans.BeanCopier beanCopier = BeanCopier.create(CosmosY.class, CosmosN.class, false);
            beanCopier.copy(cosmosY, cosmosN4, null);
            count++;
        }
        Long end4 = System.currentTimeMillis();
        long spend4 = end4 - start4;
        //5. mirror mirror.setValue(obj, mirror.getField("name"), "XiaoBai");
        Long start5 = System.currentTimeMillis();
        Mirror<CosmosY> mirrorY = Mirror.me(CosmosY.class);
        Mirror<CosmosN> mirrorN = Mirror.me(CosmosN.class);
        Field[] fields = mirrorN.getFields();
        while (count < 50000) {
            cosmosN5 = new CosmosN();
            for (Field field : fields) {
                try {
                    mirrorN.setValue(cosmosN5, field.getName(), mirrorY.getValue(cosmosY, mirrorY.getField(field.getName())));
        ...
        long spend5 = end5 - start5;
        //6.自写反射
        Long start6 = System.currentTimeMillis();
        Field[] fields6 = CosmosN.class.getDeclaredFields();

        while (count < 6000) {
            cosmosN6 = new CosmosN();
            for (Field field : fields6) {
                try {
                    field.set(cosmosN6, CosmosY.class.getDeclaredField(field.getName()).get(cosmosY));
                } catch (IllegalAccessException e) {
                    e.printStackTrace();
                } catch (NoSuchFieldException e) {
                    e.printStackTrace();
        ...
        long spend6 = end6 - start6;

        //7.json 序列化
        Long start7 = System.currentTimeMillis();
        while (count < 6000) {
            cosmosN7=new CosmosN();
            cosmosN7 = JSON.parseObject(JSON.toJSONString(cosmosY), CosmosN.class);
            count++;
        }
        Long end7 = System.currentTimeMillis();
        long spend7 = end7 - start7;

        System.out.println("1.使用org.apache.commons.beanutils.BeanUtils.copyProperties, 耗时:" + spend1 + " ms");
        System.out.println("2.使用org.springframework.beans.BeanUtils.copyProperties, 耗时:" + spend2 + " ms");
        System.out.println("3.使用net.sf.cglib.beans.BeanCopier.copy ,耗时:" + spend3 + " ms");
        System.out.println("4.使用org.springframework.cglib.beans.BeanCopier.copy ,耗时:" + spend4 + " ms");
        System.out.println("5.使用mirror mirror.setValue ,耗时:" + spend5 + " ms");
        System.out.println("7.使用自写反射 ,耗时:" + spend6 + " ms");
        System.out.println("7.使用json序列化 ,耗时:" + spend7 + " ms");
